  ...
  <Tab title="macOS" icon="apple">
    <Steps>
      ...
      <Step title="Manual download (if needed)">
        If auto-update isn't working, download from [browseros.com](https://browseros.com) or [GitHub Releases](https://github.com/Rekonquest/BrowserOS-in-progress/releases/latest).
      </Step>
    </Steps>
  </Tab>
  ...
  <Tab title="Windows" icon="windows">
    <Steps>
      ...
      <Step title="Download (if update available)">
        If an update is available, download from [browseros.com](https://browseros.com) or [GitHub Releases](https://github.com/Rekonquest/BrowserOS-in-progress/releases/latest).
      </Step>
      <Step title="Install">
