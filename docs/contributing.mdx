...
- [GitHub Repository](https://github.com/Rekonquest/BrowserOS-in-progress)
- [Discord Community](https://discord.gg/YKwjt5vuKr)
- [Report Issues](https://github.com/Rekonquest/BrowserOS-in-progress/issues)

## Ways to Contribute

**Report bugs** — [Open an issue](https://github.com/Rekonquest/BrowserOS-in-progress/issues/new) with steps to reproduce, expected vs actual behavior, and screenshots.

**Suggest features** — Share ideas on [GitHub](https://github.com/Rekonquest/BrowserOS-in-progress/issues/99) or [Discord](https://discord.gg/YKwjt5vuKr).
...
- **GitHub Issues** — [github.com/BrowserOS-ai/BrowserOS/issues](https://github.com/Rekonquest/BrowserOS-in-progress/issues)
- **GitHub Discussions** — [github.com/BrowserOS-ai/BrowserOS/discussions](https://github.com/Rekonquest/BrowserOS-in-progress/discussions)
